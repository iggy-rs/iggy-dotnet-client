...
public sealed class HeaderValueTests
{
    ...
    public void Raw_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.Raw(data);
    ...
    {
        Assert.Throws<ArgumentException>(() => HeaderValue.String(""));
        Assert.Throws<ArgumentException>(() => HeaderValue.String(new string('a', 256)));
    }
    ...
    public void String_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.String(value);
    ...
    {
        bool value = true;
        HeaderValue header = HeaderValue.Bool(value);
    ...
    {
        int value = 42;
        HeaderValue header = HeaderValue.Int32(value);
    ...
    public void Int64_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.Int64(value);
    ...
    public void Int128_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.Int128(value);
    ...
    public void Guid_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.Guid(value);
    ...
    {
        uint value = 12345U;
        HeaderValue header = HeaderValue.UInt32(value);
    ...
    public void UInt64_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.UInt64(value);
    ...
    public void UInt128_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.UInt128(value);
    ...
    {
        float value = 3.14f;
        HeaderValue header = HeaderValue.Float32(value);
    ...
    public void Float64_ReturnsCorrectValue()
    {
        ...
        HeaderValue header = HeaderValue.Float64(value);
